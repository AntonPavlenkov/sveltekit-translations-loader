...
The plugin automatically generates translation function files in a `messages-generated` directory next to your `defaultPath`. For example:

```
src/types/
├── default-translations.ts          # Your translation definitions
└── messages-generated/              # Auto-generated (add to .gitignore)
...
The plugin automatically adds the generated `messages-generated/` directory to your `.gitignore` file by default. This happens intelligently:
